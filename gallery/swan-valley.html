...
<p class="title"><strong>Swan Valley</strong></p>
<p class="subtitle"><em>July 2022</em></p>
...
<div class="container">
  ...
  <div class="mySlides1 fade">
    <img src="https://live.staticflickr.com/65535/53548089457_b6e17edb41_o.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev1" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next1" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
  ...
  <div class="mySlides1 fade">
    <img src="https://live.staticflickr.com/65535/53548961191_1f1eb676dc_o.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev1" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next1" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
  ...
  <div class="mySlides1 fade">
    <img src="https://live.staticflickr.com/65535/53548089397_54d675677a_o.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev1" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next1" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
    ...
    <div class="bodytext-centre">Ilford HP5 135
        <br>Scan
    </div>
