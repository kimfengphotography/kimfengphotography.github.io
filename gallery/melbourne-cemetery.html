...
<p class="title"><strong>Melbourne General Cemetery</strong></p>
<p class="subtitle"><em>April 2023</em></p>
...
<div class="container">
  <div class="mySlides1 fade">
    ...
    <div class="bodytext-centre"></div>
  </div>

  <div class="mySlides1 fade">
    <img src="https://live.staticflickr.com/65535/53548050652_52a2b8c1de_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev1" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next1" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
  ...
  <div class="mySlides1 fade">
    <img src="https://live.staticflickr.com/65535/53549255554_b336c6d005_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev1" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next1" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
  ...
  <div class="mySlides1 fade">
    <img src="https://live.staticflickr.com/65535/53549359280_e9dbb8f000_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev1" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next1" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
  ...
  <div class="mySlides1 fade">
    <img src="https://live.staticflickr.com/65535/53549255654_c6f40d46fa_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev1" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next1" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
