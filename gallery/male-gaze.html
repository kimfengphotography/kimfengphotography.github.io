...
<p class="title"><strong>The Male Gaze</strong></p>
<p class="subtitle">With Rachel Lim
<br><br>
<em>May 2021</em></p>
...
<div class="container">
   <div class="mySlides fade">
    <img src="https://live.staticflickr.com/65535/53549084356_e34a7c5952_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
    <div class="text">The Panopticon</div>
  </div>

   <div class="mySlides fade">
    <img src="https://live.staticflickr.com/65535/53549522900_6baf70a3f0_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
    <div class="text">CCTV 1</div>
  </div>

   <div class="mySlides fade">
    <img src="https://live.staticflickr.com/65535/53548214332_68d8cb42fc_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
    <div class="text">CCTV 2</div>
  </div>
