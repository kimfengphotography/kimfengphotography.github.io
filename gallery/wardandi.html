...
<p class="title"><strong>Wardandi country</strong></p>
<p class="subtitle"><em>November - December 2018</em></p>

<div class="slideshow-container">

<div class="container">
  <div class="mySlides fade">
    <img src="https://live.staticflickr.com/65535/53549352428_3174b27bd3_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
    <div class="text">Ngilgi Cave</div>
  </div>

  <div class="mySlides fade">
    <img src="https://live.staticflickr.com/65535/53549352343_aa783933b6_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
    <div class="text">Sugarloaf Rock</div>
  </div>

  <div class="mySlides fade">
    <img src="https://live.staticflickr.com/65535/53549157976_bbc631ff6f_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
    <div class="text">Wyadup Rocks</div>
  </div>

  <div class="mySlides fade">
    <img src="https://live.staticflickr.com/65535/53549352133_e37993a1b8_b.jpg" style="width:100%">
    <div class="centeredButtons">
        <a class="prev" onclick="plusSlides(-1,0)">&#10094;</a>
        <a class="next" onclick="plusSlides(1,0)">&#10095;</a>
    </div>
    <div class="text">Bunker Bay</div>
  </div>
